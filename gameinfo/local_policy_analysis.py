...
def evaluate_nine_dead_two(set,flag):
	rflag = 0.5
	if flag == 0.5:
		rflag = 1
	high_edge = 7
...
def evaluate_nine_alive_two(set,flag):
	rflag = 0.5
	if flag == 0.5:
		rflag = 1
	high_edge = 7
...
def evaluate_nine_dead_three(set,flag):
	rflag = 0.5
	if flag == 0.5:
		rflag = 1
	high_edge = 7
...
def evaluate_nine_alive_three(set,flag):
	rflag = 0.5
	if flag == 0.5:
		rflag = 1
	high_edge = 7
...
def evaluate_nine_dead_four (set_x,color):
...
def evaluate_nine_alive_four (set_x,color) :
	re_set = [[0 for x in range(9)] for y in range(9)]
	for y in range(9):
		for x in range(9):
			if set_x[x][y] == 0:
